$(document).ready(function(){ //jquery function/to make a function available after the document is loaded
    ...
    function insert(){
       ...
       for(let i=0;i<$("td").length;i++){
        ...
        $("td").eq(i).on("click", function(){ //using click function

            if($("td").eq(i).html() == ""){
                
                    if(alternate % 2 == 0){ // module operator
